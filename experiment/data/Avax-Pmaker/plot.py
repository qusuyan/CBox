...
ax.plot(df["time"], df["unlimited_inflight"] / 1000, "s-", color=unlimited_color, label="Inf Inflight")
ax.plot(df["time"], df["unlimited_inflight_no_timeout"] / 1000, "^-", color=unlimited_no_timeout_color, label="Inf Inflight (No Timeout)")
ax.set_ylim((0, 9))
...
plt.subplots_adjust(left=0.105, right=0.99, top=0.99, bottom=0.15)
