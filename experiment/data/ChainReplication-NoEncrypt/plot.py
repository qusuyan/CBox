...
# plot tput
tput_ax.axvline(x = 220, color=ecore1_color_dark, linestyle="--", linewidth=0.7)
tput_ax.axvline(x = 220, color=ecore2_color_dark, linestyle="--", linewidth=0.7)
...
tput_ax.set_ylabel('Tput (ktps.)', labelpad=-3.5)
tput_ax.set_ylim((0, 105))
tput_ax.legend(loc="lower right")

# plot sched delay
sched_ax.axvline(x = 220, color=ecore1_color_dark, linestyle="--", linewidth=0.7)
sched_ax.axvline(x = 220, color=ecore2_color_dark, linestyle="--", linewidth=0.7)
...
# plot msg delay
msg_ax.axvline(x = 220, color=ecore1_color_dark, linestyle="--", linewidth=0.7)
msg_ax.axvline(x = 220, color=ecore2_color_dark, linestyle="--", linewidth=0.7)
...
# plot cpu util
cpu_ax.axvline(x = 220, color=ecore1_color_dark, linestyle="--", linewidth=0.7)
cpu_ax.axvline(x = 220, color=ecore2_color_dark, linestyle="--", linewidth=0.7)
...
cpu_ax.set_ylabel('CPU (%)', labelpad=-3.5)
