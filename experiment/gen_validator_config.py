...
def gen_validator_configs(nodes: list[int], 
    ...
    config = [gen_node_config(correct_nodes, "Correct", correct_node_config, max_concurrency)] if num_faulty == 0 else \
        [gen_node_config(correct_nodes, "Correct", correct_node_config, max_concurrency), 
...
if __name__ == "__main__":
    ...
    parser.add_argument("-t", "--faulty-type", type=str, default="", help="type of faulty node")
