...
//!
//! Author: Guanzhou Hu
//! Source: https://github.com/josehu07/summerset/blob/main/src/utils/config.rs
...
macro_rules! parsed_config {
    ($config_str:expr => $config_type:ty; $($field:ident),+) => {{
        ...
        let compose_config = || -> Result<$config_type, CopycatError> {
...
mod config_tests {
    ...
    #[test]
    fn parse_from_none() -> Result<(), CopycatError> {
    ...
    #[test]
    fn parse_from_partial() -> Result<(), CopycatError> {
